...
<body>
    ...
    <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-">
                        <a href="appointment.php" class="non-style-link-menu"><div><p class="menu-text">Manage Bookings</p></a></div>
                    </td>
                </tr>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-">
                        <a href="vehicleowner.php" class="non-style-link-menu  non-style-link-menu-active"><div><p class="menu-text">Customers</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <a href="vehicleowner.php" ><button  class="login-btn btn-primary-soft btn btn-icon-back"  style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px"><font class="tn-in-text">Back</font></button></a>
    ...
    if($_GET){
        ...
        $action=$_GET["action"];
            ...
            <div id="popup1" class="overlay">
                    <div class="popup">
                    <center>
                        <a class="close" href="vehicleowner.php">&times;</a>
                        <div class="content">
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="vehicleowner.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
